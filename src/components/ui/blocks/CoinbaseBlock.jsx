...
import { mineCoinbaseBlockNonce, modifyCoinbaseBlockchain, setMiningCoinbaseBlock } from '../../../Redux/actions/coinbaseBlockchainActions';

export default function CoinbaseBlock({ id, TYPE }) {
  ...
  const handleChange = (e) => {
    ...
    dispatch(modifyCoinbaseBlockchain({ ...inputs, [name]: value }, id, blockchain, TYPE));
  };

  const handleTokens = (e, idd) => {
    const { name, value } = e.target;
    dispatch(modifyCoinbaseBlockchain({
      ...inputs,
  ...
  const mineNonce = () => {
    dispatch(setMiningCoinbaseBlock(id, TYPE));
    dispatch(mineCoinbaseBlockNonce(id, blockchain, TYPE));
  };
